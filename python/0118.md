...
| `%U` | 연중 주 번호(일요일이 주의 시작)를 0으로 채워진 10진수로. 첫 번째 일요일에 선행하는 새해의 모든 날은 주 0으로 간주합니다. | 00, 01, …, 53                                                | (7), (9) |
| `%W` | 연중 주 번호(월요일이 주의 시작)를 십진수로. 첫 번째 월요일에 선행하는 새해의 모든 말은 주 0으로 간주합니다. | 00, 01, …, 53                                                | (7), (9) |
...
[출처](python.org/ko/3/library/datetime.html#strftime-and-strptime-format-codes)
